...
public class user1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtuname.setFont(new java.awt.Font("Constantia", 1, 14)); // NOI18N

        txtpass.setFont(new java.awt.Font("Constantia", 1, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String txtusertype = txtutype.getSelectedItem().toString();
        
        if(txtuname.getText().isEmpty() || txtpass.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Username or password is blank","Swing Tester", JOptionPane.ERROR_MESSAGE);

        }
        else{
        
        try {
            pst = (PreparedStatement) con.prepareStatement("insert into user (uname,pass,utype)values(?,?,?)");
            
            pst.setString(1, username);
            pst.setString(2, password);
            pst.setString(3, txtusertype);
